...
public class TeleportMirrorBlock extends MirrorBlock {

    public TeleportMirrorBlock(Properties properties, MirrorTier tier) {
        super(properties, tier, MirrorType.TELEPORT);
    }
