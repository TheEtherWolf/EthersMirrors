...
public class MirrorCallMadeTrigger extends SimpleCriterionTrigger<MirrorCallMadeTrigger.TriggerInstance> {

    public static final ResourceLocation ID = new ResourceLocation("ethersmirrors", "mirror_call_made");
