...
public class PocketThemeSetTrigger extends SimpleCriterionTrigger<PocketThemeSetTrigger.TriggerInstance> {

    public static final ResourceLocation ID = new ResourceLocation("ethersmirrors", "pocket_theme_set");
