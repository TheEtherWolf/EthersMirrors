...
public class MirrorTeleportedTrigger extends SimpleCriterionTrigger<MirrorTeleportedTrigger.TriggerInstance> {

    public static final ResourceLocation ID = new ResourceLocation("ethersmirrors", "mirror_teleported");
